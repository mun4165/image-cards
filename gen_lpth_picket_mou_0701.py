...
draw.text((32,22), "LPTH, 대드론 방어 Picket과 MOU", font=bold(40), fill=ACCENT)
draw.text((32,80), "어제 +12% 급등의 진짜 방아쇠는", font=bold(21), fill=GRAY)
...
draw.text((60,ty+44), "라이트패스가 대드론 방어 시스템의 '눈'(360도 패시브 적외선)을 공급",
...
band(by, bh, TEAL, (8,30,30), "방아쇠",
     "MOU가 국방 이미징 스토리를 검증", "가장 뜨거운 니치(대드론)에 실제 진입 = 재평가")
band(by+step, bh, BLUE, (12,20,38), "증폭기",
     "저점 대비 급등주 + 공매도 약 11%", "모멘텀 추격 · 단 커버 1.5일로 스퀴즈는 제한적")
band(by+step*2, bh, AMBER, (40,30,8), "주의",
     "MOU는 구속력 없는 의향서", "매출은 아직 0 · 실제 수주 전환이 다음 확인점")

draw.line([(32,H-30),(W-32,H-30)], fill=DARK_GRAY, width=1)
draw.text((32,H-22), "2026.07.01  |  호재의 흥분과 테제를 갈라서 본다", font=font(15), fill=GRAY)

out = os.path.join(OUT_DIR, "2026-07-01_LPTH_Picket대드론MOU.png")
